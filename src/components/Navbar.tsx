    ...
    <div>
        <header>
            <div className="blog-logo">
                <p><strong>B</strong>loggerX</p>
            </div>
            <div className="input-box">
                <input type="text" placeholder='Search for blog'/>
                <div className="svg-con"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
...
<div className="pic"><LiaUserCircle/></div>
